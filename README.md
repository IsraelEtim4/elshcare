...
```bash
git clone https://github.com/IsraelEtim4/elshcare
cd elshcare
```
...
Public assets used in the project can be found [here](https://drive.google.com/file/d/1Pj_DSXC0FA2BE2YSBxXBZQ96YED6ozXl/view?usp=sharing)
